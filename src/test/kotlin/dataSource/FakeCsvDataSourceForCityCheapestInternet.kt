...
class FakeCsvDataSourceForCityCheapestInternet : CostOfLivingDataSource {
...
class FakeCsvDataSourceForCityCheapestInternetEmptyList : CostOfLivingDataSource {
    override fun getAllCitiesData(): List<CityEntity> {
        return emptyList()
    }
}

class FakeCsvDataSourceForCityCheapestInternetWithNullSalaries : CostOfLivingDataSource {
    override fun getAllCitiesData(): List<CityEntity> {
        return listOf(
            CityEntity(
            cityName = "Cairo",
...
class FakeCsvDataSourceForCityCheapestInternetWithNullInternetPrice : CostOfLivingDataSource {
    override fun getAllCitiesData(): List<CityEntity> {
        return listOf(
            CityEntity(
                cityName = "Cairo",
            ...
            CityEntity(
                ...
                averageMonthlyNetSalaryAfterTax = 800f,
                dataQuality = true
            ),
